...
const Applist = ({ app: {AppName, Catagory, Icon, Rating, } }) => {
  return (
        ...
        <View className="flex-row gap-3 items-start">
            <View className="justify-center items-center flex-row flex-1" >
                ...
                <View className="justify-center flex-1 ml-3 gap-y-1">
                    <Text className="text-primary font-semibold text-sm" numberOfLines={1}>{AppName}</Text>
            ...
            <View className="justify-center items-center flex-row gap-2">
                <View className="bg-blue-300 items-center justify-center  w-12 h-7 me-2 px-2.5 py-0.5 border-1 border-gray-200 rounded">
